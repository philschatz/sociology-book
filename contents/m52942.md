...
**Colorism**{: data-type="term"} is another kind of prejudice, in which someone believes one type of skin tone is superior or inferior to another within a racial group. Studies suggest that darker skinned African Americans experience more discrimination than lighter skinned African Americans (Herring, Keith, and Horton 2004; Klonoff and Landrine 2000). For example, if a white employer believes a black employee with a darker skin tone is less capable than a black employee with lighter skin tone, that is colorism. At least one study suggested the colorism affected racial socialization, with darker-skinned black male adolescents receiving more warnings about the danger of interacting with members of other racial groups than did lighter-skinned black male adolescents (Landor et al. 2013).
